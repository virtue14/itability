package com.itability.memberservice.client;

import com.itability.memberservice.mypage.dto.ReqeuestRecruitCategory;
import com.itability.memberservice.mypage.dto.RequestRecruitCategory;
import com.itability.memberservice.mypage.dto.ResponseRecruitCategory;
...
@FeignClient(name = "ITABILITY-BOARD-SERVICE", url = "${gateway.url}") // gateway에 갈 클라이언트의 이름, gateway 주소
